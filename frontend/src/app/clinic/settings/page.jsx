...
export default function ClinicSettingsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setForm(f => ({
        ...f,
        nurseId: updatedProfile.faculty_id || "",
        ...
        <form className="bg-white rounded shadow-sm p-4 w-100" style={{ borderRadius: 16, width: '100%' }} onSubmit={handleSubmit}>
          ...
          <div className="row g-4">
            <div className="col-md-6">
              <div className="mb-3">
                <label className="form-label mb-1">Nurse ID</label>
                <input type="text" className="form-control" name="nurseId" value={form.nurseId} disabled />
              </div>
              <div className="mb-3">
