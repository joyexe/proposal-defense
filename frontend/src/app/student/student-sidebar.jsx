...
import { faGauge, faFileMedical, faCalendarCheck, faRobot, faBullhorn } from '@fortawesome/free-solid-svg-icons';

const links = [
  { href: "/student/dashboard", label: "Dashboard", icon: faGauge },
  { href: "/student/health-record", label: "Permit Requests", icon: faFileMedical },
  { href: "/student/appointment", label: "Appointments", icon: faCalendarCheck },
  { href: "/student/amieti", label: "AMIETI", icon: faRobot },
  { href: "/student/bulletin", label: "Bulletin", icon: faBullhorn },
];

export default function StudentSidebar({ setActiveText }) {
  ...
  return (
    <aside
      className={`student-sidebar d-flex flex-column justify-content-between p-0 ${isCollapsed ? "collapsed" : "expanded"}`}
