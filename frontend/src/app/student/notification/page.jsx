...
import { getStudentNotifications, markStudentNotificationsRead, getStudentAppointmentNotifications, markStudentAppointmentNotificationsRead } from '../../utils/api';
    ...
    const loadNotifications = async () => {
      try {
        ...
        const [permitData, appointmentData] = await Promise.all([
          ...
          getStudentAppointmentNotifications()
        ]);
        ...
        // Mark notifications as read when student visits the page
        if (allNotifications && allNotifications.length > 0) {
          try {
            await Promise.all([
              markStudentNotificationsRead(),
              markStudentAppointmentNotificationsRead()
            ]);
          } catch (error) {
