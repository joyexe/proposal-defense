...
import { faGauge, faUsers, faChartBar, faFileMedical, faClipboardList, faGear } from '@fortawesome/free-solid-svg-icons';
...
const links = [
  ...
  { href: "/admin/logs", label: "System Logs", icon: faClipboardList },
  { href: "/admin/settings", label: "Settings", icon: faGear },
];

export default function AdminSidebar({ setActiveText }) {
  ...
  return (
    <aside
      className={`admin-sidebar d-flex flex-column justify-content-between p-0 ${isCollapsed ? "collapsed" : "expanded"}`}
