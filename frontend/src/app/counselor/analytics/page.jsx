...
import { getMentalHealthTrends, getRiskLevelDistribution, getMentalHealthAlertsAnalytics, getChatbotMentalHealthAnalytics, getMentalHealthAnalyticsSummary, getFlaggedKeywords, generateCounselorPDFReport } from "../../utils/api";
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        ...
        // Debug: Log the trends data to see the structure
        ...
        <ul className="nav nav-pills w-100">
          <li className="nav-item flex-fill">
            <button
              ...
              onClick={() => router.push('/counselor/analytics')}
            >
          ...
          <li className="nav-item flex-fill">
            <button
              ...
              onClick={() => router.push('/counselor/analytics/alerts')}
            >
          ...
          <li className="nav-item flex-fill">
            <button
              ...
              onClick={() => router.push('/counselor/analytics/engagements')}
            >
              AMIETI Chatbot
            </button>
          </li>
