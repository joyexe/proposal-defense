...
export default function CounselorBulletinPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const postData = {
        ...
        end_date: form.to,
        post_type: 'Mental', // Capitalized to match Django model
      };
      ...
      router.push('/counselor/bulletin/bulletin-posts');
    } catch (error) {
  ...
  return (
    <div className="container-fluid py-4">
      ...
      <div className="d-flex align-items-center mb-4">
        <ul className="nav nav-pills w-100">
          <li className="nav-item flex-fill">
            <button
              className={`nav-link w-100 border ${pathname === '/counselor/bulletin' ? 'bg-success text-white' : 'bg-light text-dark'}`}
              onClick={() => router.push('/counselor/bulletin')}
          ...
          <li className="nav-item flex-fill">
            <button
              className={`nav-link w-100 border ${pathname === '/counselor/bulletin/bulletin-posts' ? 'bg-success text-white' : 'bg-light text-dark'}`}
              onClick={() => router.push('/counselor/bulletin/bulletin-posts')}
      ...
      <div className="bg-white p-4 rounded shadow-sm border w-100">
        <h5 className="fw-bold mb-4">{isEditing ? 'Edit Mental Health Bulletin' : 'Create New Mental Health Bulletin'}</h5>
